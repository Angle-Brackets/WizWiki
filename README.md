...
[![Tests](https://github.com/Angle-Brackets/WizWiki/actions/workflows/test.yml/badge.svg)](https://github.com/Angle-Brackets/WizWiki/actions/workflows/test.yml)
[![PyPI version](https://img.shields.io/pypi/v/wizwiki.svg)](https://pypi.org/project/wizwiki/)
[![License](https://img.shields.io/github/license/Angle-Brackets/WizWiki)](https://github.com/Angle-Brackets/WizWiki/blob/main/LICENSE)

A modern, high-performance, asynchronous Python library designed to scrape and query the Wizard101 Wiki with precision and ease.
